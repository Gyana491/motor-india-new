  ...
  if (!post) {
    return (
      <main className="container mx-auto px-4 py-8">
        ...
        <p>Sorry, we couldn&apos;t find the post you&apos;re looking for.</p>        <Link href="/hindi" className="text-red-600 hover:underline mt-4 inline-block">
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {      title: post.title,
      ...
      tags: [...post.categories.map(cat => cat.name), ...post.tags.map(tag => tag.name)]
    }
  }
}