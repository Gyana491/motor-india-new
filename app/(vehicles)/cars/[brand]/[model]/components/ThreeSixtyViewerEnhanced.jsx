    ...
    <div className="fixed inset-0 z-50 bg-black bg-opacity-90 flex items-center justify-center touch-none">
      <div className="w-full h-full max-w-7xl max-h-screen p-2 sm:p-4 flex flex-col">
        <div className="flex justify-between items-center mb-2 sm:mb-4">
          <h3 className="text-white text-base sm:text-xl font-medium ml-1 sm:ml-0">
            {title}
          </h3>
          <button
            onClick={onClose}
          ...
          <div className="mb-2 sm:mb-3 flex justify-center">
            <div className="inline-flex rounded-md shadow-sm bg-gray-800 p-1">
              ...
              <button
                ...
                data-view="interior"
                aria-pressed={activeView === "interior"}
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
        ...
        <div className="mt-2 sm:mt-4 flex justify-between items-center">
          <div className="text-white text-sm">
            <span className="px-3 py-1 bg-red-600 rounded-full">
              {activeView === "exterior" ? "Exterior View" : "Interior View"}
            </span>
          </div>
          <button
            onClick={onClose}
...
export default function ThreeSixtyViewerEnhanced({
  threeSixtyView,
  title,
  brand,
  model,
  ...
  const exploreLinks = [
    {
      name: "Specifications",
      path: `/cars/${brand}/${model}/specifications`,
      icon: "M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01",
    },
    {
      name: "Colors",
      path: `/cars/${brand}/${model}/colors`,
          ...
          <div className="flex rounded-lg overflow-hidden border border-gray-200 shadow-sm bg-white">
            {hasExterior && (
              ...
              >
                ...
                {activeView === "exterior" && (
                  <span className="ml-1 bg-white bg-opacity-20 text-[10px] sm:text-xs px-1.5 py-0.5 rounded-full hidden sm:inline-block">
                    Active
                  </span>
                )}
              </button>
              ...
              <div className="p-2.5 sm:p-3 space-y-1.5 sm:space-y-2">
                {exploreLinks.map((link, idx) => (
                  ...
                  >
                    ...
                    <svg
                      className="w-3.5 h-3.5 sm:w-4 sm:h-4 ml-auto text-gray-400 group-hover:text-red-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
