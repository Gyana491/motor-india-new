...
// Client component for interactions (sorting, filtering, images, and form navigation)
function SearchClient({ initialQuery, initialResults }) {
  'use client';
  ...
  // Compute filtered/sorted results on client from initial SSR data
            ...
            <form onSubmit={handleNewSearch} className="flex-shrink-0">
              <div className="flex items-center bg-gray-50 rounded-lg border border-gray-300 focus-within:ring-2 focus-within:ring-red-500 focus-within:border-red-500">
                ...
                <input
                  ...
                  onKeyDown={(e) => {
                    // Allow Enter to submit this form, to navigate to SSR page
                  }}
                />
                <button
                  type="submit"
